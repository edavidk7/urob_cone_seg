...
from .activation_utils import get_act_fn, get_act_layer
...
def _gen_mobilenet_v3_rw(variant, channel_multiplier=1.0, pretrained=False, **kwargs):
    ...
    with layer_config_kwargs(kwargs):
        model_kwargs = dict(
            ...
            se_kwargs=dict(gate_fn=get_act_fn(
                'hard_sigmoid'), reduce_mid=True),
...
def mobilenetv3_large_075(pretrained=False, **kwargs):
    ...
    model = _gen_mobilenet_v3('mobilenetv3_large_075',
                              0.75, pretrained=pretrained, **kwargs)
    return model
...
def mobilenetv3_large_100(pretrained=False, **kwargs):
    ...
    model = _gen_mobilenet_v3('mobilenetv3_large_100',
                              1.0, pretrained=pretrained, **kwargs)
    return model
